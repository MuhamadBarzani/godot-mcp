...
>
> "MANDATORY PROTOCOL: 1. Call get_server_info() for a full capability snapshot. 2. Call list_toolsets() to see what is available. 3. Call enable_toolset(category) for every category you plan to use. 4. Only after enabling can you call the tools in that category."
...
1. Call get_server_info() for a full capability snapshot: toolsets, prompts, resources, bridge state, and troubleshooting.
...
- runtime     → run_and_capture, play_scene, stop_scene
...
If you get 'ToolError: unknown tool', the toolset is not enabled. Call enable_toolset first.
```
...
**What the agent will do:**
- `create_node(parent_path=".", node_type="CharacterBody2D", node_name="Player")`
- `set_node_property(node_path="./Player", property="position", value={"x": 400, "y": 300})`
- `create_node(parent_path="./Player", node_type="Camera2D", node_name="Camera2D")`
...
**What the agent will do:**
- `write_script(script_path="res://scripts/player.gd", content="extends CharacterBody2D\n\n@export var speed: float = 300.0\n\nfunc _ready() -> void:\n\tadd_to_group('player')\n\nfunc _physics_process(_delta: float) -> void:\n\tvar direction := Input.get_vector('ui_left', 'ui_right', 'ui_up', 'ui_down')\n\tvelocity = direction * speed\n\tmove_and_slide()\n")`
...
**What the agent will do:**
- `create_node(parent_path=".", node_type="Node2D", node_name="Coins")`
- For each coin:
  - `create_node(parent_path="./Coins", node_type="Area2D", node_name="Coin1")`
  - `set_node_property(node_path="./Coins/Coin1", property="position", value={"x": 200, "y": 200})`
  - `create_node(parent_path="./Coins/Coin1", node_type="CollisionShape2D", node_name="CollisionShape2D")`
  - `set_node_property(node_path="./Coins/Coin1/CollisionShape2D", property="shape", value={"type": "CircleShape2D", "radius": 16})`
...
**What the agent will do:**
- `write_script(script_path="res://scripts/coin.gd", content="extends Area2D\n\nsignal collected\n\nfunc _ready() -> void:\n\tadd_to_group('coins')\n\tbody_entered.connect(_on_body_entered)\n\nfunc _on_body_entered(body: Node2D) -> void:\n\tif body.is_in_group('player'):\n\t\tcollected.emit()\n\t\tqueue_free()\n")`
- `attach_script(node_path="./Coins/Coin1", script_path="res://scripts/coin.gd")`
- `attach_script(node_path="./Coins/Coin2", script_path="res://scripts/coin.gd")`
- `attach_script(node_path="./Coins/Coin3", script_path="res://scripts/coin.gd")`
...
**What the agent will do:**
- `create_node(parent_path="./Coins/Coin1", node_type="ColorRect", node_name="ColorRect")`
- `set_node_property(node_path="./Coins/Coin1/ColorRect", property="offset_left", value=-16)`
- `set_node_property(node_path="./Coins/Coin1/ColorRect", property="offset_right", value=16)`
- `set_node_property(node_path="./Coins/Coin1/ColorRect", property="offset_top", value=-16)`
- `set_node_property(node_path="./Coins/Coin1/ColorRect", property="offset_bottom", value=16)`
- `set_node_property(node_path="./Coins/Coin1/ColorRect", property="color", value={"r": 1, "g": 0.84, "b": 0, "a": 1})`
...
**What the agent will do:**
- `create_node(parent_path=".", node_type="Node", node_name="GameManager")`
- `write_script(script_path="res://scripts/game_manager.gd", content=...)`
- `attach_script(node_path="./GameManager", script_path="res://scripts/game_manager.gd")`
- `set_node_property(node_path="./GameManager", property="total_coins", value=3)`
...
**What the agent will do:**
- `create_node(parent_path=".", node_type="CanvasLayer", node_name="UI")`
- `create_node(parent_path="./UI", node_type="Label", node_name="ScoreLabel")`
- `set_node_property(node_path="./UI/ScoreLabel", property="text", value="Score: 0 / 3")`
- `set_node_property(node_path="./UI/ScoreLabel", property="offset_left", value=20)`
- `set_node_property(node_path="./UI/ScoreLabel", property="offset_top", value=20)`
- `create_node(parent_path="./UI", node_type="Label", node_name="WinLabel")`
...
**What the agent will do:**
- `debug_workflow()` — runs a comprehensive check that includes parse errors across all `.gd` files automatically
- Or call `get_parse_errors(script_path="res://scripts/my_script.gd")` per script if you want to focus on one
...
**What the agent will do:**
- `set_setting(key="application/run/main_scene", value="res://scenes/main.tscn")`
- `register_autoload(name="MCPRuntimeProbe", path="res://addons/godot_mcp/mcp_runtime_probe.gd")`
...
**What the agent will do:**
- `enable_toolset("runtime")`
- `play_scene(scene_path="res://scenes/main.tscn")`
...
- `simulate_action(action="ui_right", pressed=true)`
- Wait 1 second (the agent may use its own timer)
- `simulate_action(action="ui_right", pressed=false)`
...
- `assert_node_state(node_path="/root/Main/GameManager", property="coin_count", expected=0, op="==")`
...
**What the agent will do:**
- `simulate_action(action="ui_up", pressed=true)`
- Wait (agent-managed)
- `simulate_action(action="ui_up", pressed=false)`
- `assert_node_state(node_path="/root/Main/GameManager", property="coin_count", expected=1, op=">=")`
...
**What the agent will do:**
- `find_ui_elements(name_contains="Score")`
...
**What the agent will do:**
- `enable_toolset("batch")`
- `find_nodes_by_type(node_type="Area2D", scene_path="res://scenes/main.tscn")` to identify coins
- `batch_set_property(scene_path="res://scenes/main.tscn", node_paths=["./Coins/Coin1", "./Coins/Coin2", "./Coins/Coin3"], property="modulate", value={"r": 1, "g": 0, "b": 0, "a": 1})`
...
**What the agent will do:**
- `delete_node(node_path="./Player", dry_run=true)`
...
**What the agent will do:**
- `play_input_sequence(events=<recorded_events>, delay_ms=100)`
